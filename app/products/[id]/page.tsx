...
import { Star, Heart, ArrowLeft, Plus, Minus, Loader2, AlertCircle, Truck, Shield, RotateCcw, Award } from "lucide-react"
                ...
                <Card>
                  <CardContent className="p-8">
                    ...
                    <div className="space-y-4 text-muted-foreground">
                      <p>• Allow your mattress to air out daily and rotate every 3 months for even wear</p>
                      <p>• Spot clean with mild detergent and water. Do not soak or machine wash</p>
                      <p>• Use a mattress protector to prevent stains and extend the life of your mattress</p>
                      <p>• Keep away from direct sunlight when drying</p>
                      <p>• Avoid jumping or standing on the mattress</p>
                    </div>
                  </CardContent>
                </Card>
              </TabsContent>
