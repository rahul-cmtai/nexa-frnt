  ...
  const products = [
    {
      ...
      badge: "Best Seller",
      features: ["Deep Pressure Therapy", "Breathable", "Machine Washable"],
      type: "Weighted Blanket",
      sizes: ["Single", "Double", "Queen", "King"],
    },
    {
      id: 2,
      name: "Flo Fitted Bedsheets",
      originalPrice: 3999,
      salePrice: 2499,
      rating: 4.9,
      reviews: 892,
    ...
    {
      id: 3,
      name: "Flo Cooling Weighted Blanket",
      originalPrice: 11999,
      salePrice: 7999,
      rating: 4.7,
      reviews: 634,
      ...
      badge: "Cooling Tech",
      features: ["Advanced Cooling", "Temperature Control", "Hypoallergenic"],
      type: "Weighted Blanket",
      sizes: ["Double", "Queen", "King"],
    },
    {
      id: 4,
      name: "Flo Organic Bedsheet Set",
      originalPrice: 5999,
      salePrice: 3999,
      rating: 4.6,
      reviews: 456,
      ...
      badge: "Eco-Friendly",
      features: ["Organic Cotton", "Chemical-Free", "Set of 4"],
      type: "Bedsheets",
      sizes: ["Double", "Queen", "King"],
    },
    {
      id: 5,
      name: "Flo Bamboo Bedsheets",
      originalPrice: 4999,
      salePrice: 3499,
      rating: 4.8,
      reviews: 321,
      image: "/luxury-bedroom-with-premium-mattress--modern-minim.jpg",
      badge: "Antimicrobial",
      features: ["Bamboo Fiber", "Antimicrobial", "Moisture Wicking"],
      type: "Bedsheets",
      sizes: ["Single", "Double", "Queen", "King"],
    },
    {
      id: 6,
      name: "Flo Silk Bedsheet Set",
      originalPrice: 15999,
      salePrice: 10999,
      rating: 4.7,
      reviews: 789,
      image: "/person-sleeping-comfortably-on-mattress.jpg",
      badge: "Luxury",
      features: ["100% Mulberry Silk", "Temperature Regulating", "Set of 4"],
      type: "Bedsheets",
      sizes: ["Double", "Queen", "King"],
    },
  ]
              ...
              <div className="mb-6">
                ...
                <Select value={selectedType} onValueChange={setSelectedType}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="Weighted Blanket">Weighted Blanket</SelectItem>
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="flex gap-2">
                      <Button asChild className="flex-1">
                        <Link href={`/accessories/${product.id}`}>View Details</Link>
                      </Button>
                      <Button
                        variant="outline"
